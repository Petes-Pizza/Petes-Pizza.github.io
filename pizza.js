class Pizza {
    ...
    calculatePrice() {
        this.price = this.size.price + this.sauce.price;
        for (var i = 0; i < Object.keys(this.cheeses).length; i++) {
            this.price += this.cheeses[Object.keys(this.cheeses)[i]].side !== "None" * 
        ...
        for (var i = 0; i < Object.keys(this.toppings).length; i++) {
            this.price += this.toppings[Object.keys(this.toppings)[i]].side !== "None" * 
